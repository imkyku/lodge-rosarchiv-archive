            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg mb-6">
                  Все материалы организованы в соответствии со стандартами РОСАРХИВа и доступны авторизованным пользователям для ознакомления и исследования.
                </p>
                <Button 
                  onClick={() => navigate('/register')}
              ...
              <div className="bg-archive-paper paper-bg document-border p-10 rounded-lg">
                ...
                <ul className="list-disc list-inside text-archive-navy mb-3 space-y-2">
                  ...
                  <li>Гоп-Компания имени героя РФ Андреева</li>
                  <li>DRZ</li>
                  <li>Великая Жидомасонская Ложа (текущее название)</li>
                </ul>
                <p className="text-archive-navy mb-3">
